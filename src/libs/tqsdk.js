...
class TQSDK {
    constructor(mock_ws, ws_addr, tr_sign) {
        this.id = RandomStr(4);
        this.tr_sign = tr_sign;
        ...
        if (mock_ws) {
            ...
            if( !tr_sign ){
                ...
                this.ws = new TrTqWebsocket(ws_addr)
            }
    ...
    update_quote(time_now, force) {
        // this.subscribe_quote(["KQ.m@CFFEX.IF", "KQ.m@CFFEX.IH", "KQ.m@CFFEX.IC", "KQ.m@CFFEX.TF", "KQ.m@CFFEX.T", "KQ.m@CFFEX.TS", "KQ.m@SHFE.cu", "KQ.m@SHFE.au", "KQ.m@SHFE.ag", "KQ.m@SHFE.zn", "KQ.m@SHFE.al", "KQ.m@SHFE.ru", "KQ.m@SHFE.rb", "KQ.m@SHFE.fu"])
        // TQ.ws.send_json( {"aid":"peek_message"} );
        // setTimeout(() => this.update_quote(undefined,undefined), 30000);
        // console.log("4444455");
        // console.error( TQ.dm.datas.quotes )
        // return false;
