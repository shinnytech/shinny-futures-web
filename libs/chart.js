...
!(function (t, e) {
  typeof exports === 'object' && typeof module !== 'undefined' ? e(exports) : typeof define === 'function' && define.amd ? define(['exports'], e) : e(t.TradingView = t.TradingView || {})
}(this, function (t) {
  'use strict'

  function e (t, o) {
    var i = n({}, t)
    for (var s in o) typeof t[s] !== 'object' || t[s] === null || Array.isArray(t[s]) ? void 0 !== o[s] && (i[s] = o[s]) : i[s] = e(t[s], o[s])
    return i
  }
  ...
  var n = Object.assign || function (t) {
    ...
    a = (function () {
      ...
      return t.prototype.onChartReady = function (t) {
        ...
        if (t === null) throw new Error('There is no such iframe')
        return t
        ...
        if (o === null) throw new Error('There is no such element - #' + this._options.container_id)
        o.innerHTML = e
    ...
    d = a
  window.TradingView = window.TradingView || {}, window.TradingView = t, t.version = o, t.onready = i, t.widget = d, Object.defineProperty(t, '__esModule', {
    value: !0
  })
}))
